...
//   monkey.style.top = `${gameContainer.clientHeight - (isMobile ? 45 : 80)}px`; // 80 Is Monkey's Height
//   monkey.style.left = `${
//     gameContainer.clientWidth / 2 - (isMobile ? 45 : 80)
...
document.addEventListener(
  ...
  (event) => {
    ...
    if (touchEndX < touchStartX && currentPosition > 20) {
      // swipe left
      currentPosition -= 10;
      monkey.style.left = currentPosition + "px";
    } else if (
